...
function App() {
  ...
  const API_KEY = "2db99877c0ddc278e573cdc3847e919e"; // Replace 'YOUR_API_KEY' with your actual API key from OpenWeatherMap
  ...
  const getWeatherIconUrl = (c) => {
    switch (c) {
      ...
      case "Clouds":
        return "/thunder.png"; // Path to your haze weather icon
      case "Rain":
        return "/thunder.png";
      case "Mist":
        return "/rainy.png";    
